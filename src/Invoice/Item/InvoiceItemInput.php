 ...
 * }
 */
final class InvoiceItemInput implements BaseModel
{
    /** @use SdkModel<InvoiceItemInputShape> */
    use SdkModel;
    ...
    /**
     * `new InvoiceItemInput()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * InvoiceItemInput::with(item: ..., priceEach: ..., quantity: ..., vatRate: ...)
     * ```
     *
